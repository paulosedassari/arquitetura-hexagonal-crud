...
public interface ClienteSwagger {
    ...
    @PostMapping
    ResponseEntity<ClienteDto> criarCliente(@RequestBody ClienteDto clienteDto);
    ...
    @GetMapping("{nome}")
    ResponseEntity<List<ClienteDto>> buscarCliente(@PathVariable("nome") String nome);
    ...
    @PutMapping("{nome}")
    ResponseEntity<ClienteDto> atualizarCliente(@PathVariable("nome") String nome, @RequestBody ClienteDto clienteDto);
